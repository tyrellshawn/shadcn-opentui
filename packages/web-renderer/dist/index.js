...
export class CanvasTerminal {
    ...
    async init(wasmSource = "/main.wasm") {
        if (this.mounted)
            return;
    ...
    renderFrame() {
        ...
        for (let index = 0; index < meta.len; index += 1) {
            ...
            if (charCode !== 32 && charCode !== 0) {
                ...
                this.ctx.fillText(glyph, x * this.cellWidth, y * this.cellHeight + this.cellHeight - 3);
            }
        }
        if (this.cursorVisible) {
            ...
            this.ctx.fillRect(cursorX * this.cellWidth, cursorY * this.cellHeight + this.cellHeight - 2, this.cellWidth, 2);
        }
