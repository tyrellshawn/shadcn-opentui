...
const solarizedLightTheme: ThemeConfig = {
  ...
  description: "Precision light colors for machines and people",
  variant: "light",
  colors: {
    primary: "#268bd2",
    secondary: "#6c71c4",
...
const githubLightTheme: ThemeConfig = {
  ...
  colors: {
    ...
    syntaxString: "#0a3069",
    syntaxNumber: "#0550ae",
    syntaxFunction: "#0969da",
    syntaxVariable: "#8250df",
...
const catppuccinLatteTheme: ThemeConfig = {
  name: "catppuccin-latte",
  displayName: "Catppuccin Latte",
  description: "Soothing light pastel theme",
  variant: "light",
  colors: {
    primary: "#8839ef",
    secondary: "#ea76cb",
    ...
    syntaxString: "#40a02b",
    syntaxNumber: "#fe640b",
    syntaxFunction: "#04a5e5",
    syntaxVariable: "#ea76cb",
